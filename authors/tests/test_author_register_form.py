...
class AuthorRegisterFormIntegrationTest(DjangoTestCase):
    ...
    def test_password_field_have_lover_upper_case_letters_and_numbers(self):
    ...
    def test_password_and_password_confirmation_are_equal(self):
        # test if password and password2 are different
        ...
        # test if password and password2 are the same
        self.form_data['password'] = '@A123abc123'

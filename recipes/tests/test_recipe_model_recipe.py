...
class RecipeModelTest(RecipeTestBase):
    ...
    def make_recipe_no_defaults(self):
        recipe = Recipe(
            ...
            author=self.make_author(first_name='Teste', last_name='Testado', username='newuser'),
    ...
    def test_recipe_preparation_steps_html_is_false_by_default(self):
        ...
        self.assertFalse(
            ...
            msg='Recipe is_html is not False'
        )
    ...
    def test_recipe_string_representation(self):
        ...
        self.assertEqual(
            ...
            msg=f'Recipe string representation must be recipe "{needed}"'
        )
